...
cd "$(dirname "$0")/.."
for t in test_bars test_security test_paid test_adversarial test_fourth test_fifth test_sixth test_seventh test_eighth test_ninth test_tenth test_memory_v2 test_verify_loop test_tool_contracts test_skills_wiring test_mission_packaging; do
  echo "===== tests/$t.py ====="
